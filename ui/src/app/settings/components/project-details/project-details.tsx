                ...
                {((proj.spec.roles || []).length > 0 && (
                    <div className='argo-table-list argo-table-list--clickable'>
                        ...
                        {(proj.spec.roles || []).map(role => (
                            <div className='argo-table-list__row' key={`${role.name}`} onClick={() => ctx.navigation.goto(`.`, {editRole: role.name},{replace: true})}>
                                <div className='row'>
                        ...
                        {data => (
                            <div className='argo-table-list argo-table-list--clickable'>
                                ...
                                {(proj.spec.syncWindows || []).map((window, i) => (
                                    <div className='argo-table-list__row' key={`${i}`} onClick={() => ctx.navigation.goto(`.`, {editWindow: `${i}`},{replace: true})}>
                                        <div className='row'>
                                            <div className='columns small-2'>
                                                <span>
